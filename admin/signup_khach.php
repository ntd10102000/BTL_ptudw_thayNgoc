...
if (isset($_POST["signup_khach"])) {
    ...
    elseif ($pa != $rpa) {
        ...
        if ($num == 0) {
            $md5pa = md5($pa);
            $sql_insert = "INSERT INTO tbl_khach(`Email_Khach`,`SDT_Khach`,`us_khach`,`pa_khach`,`diachi`,`CauHoi_Khach`,`CauTraLoi_Khach`)
            VALUES('$email','$sdt','$us','$md5pa','$add','$qw','$tl')";
...
<body>
    <div class="loginbox" style="padding-bottom: 30px">
        ...
        <h1>register here</h1>
        <form action="signup_khach.php" method="post">
            <p>User name</p>
            ...
            <input type="submit" name="signup_khach" value="Sign Up" required>
