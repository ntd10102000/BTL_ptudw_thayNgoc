...
if (isset($_POST["retrieval"])) {
    ...
    $qw = $_POST["q_w"];
    $tl = $_POST["tl"];
    $sql = "select * from tbl_khach where us_khach like '$us' and CauHoi_khach like '$qw' and CauTraLoi_khach like '$tl' and Email_khach like '$email' and SDT_khach = $sdt;";
    $sql_query = mysqli_query($conn, $sql);
    $num = mysqli_num_rows($sql_query);
    if ($num > 0) {
        header("Location:forgot_khach.php");
    } else {
...
<body>
    <div class="loginbox" style="padding-bottom: 30px">
        ...
        <form action="retrieval_khach.php" method="post">
            <p>User name</p>
